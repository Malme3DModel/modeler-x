...
| 機能 | 元のCascadeStudio | 現在の実装 | 実装ファイル | 状態 | 備考 |
|------|------------------|-----------|-------------|------|------|
| マウスホバー | レイキャスティング | 未実装 | なし | ❌ | 最重要機能、要実装 |
| フェイスハイライト | 色変更 | 未実装 | なし | ❌ | ホバー時のハイライト |
| エッジハイライト | 色変更 | 未実装 | なし | ❌ | ホバー時のハイライト |
| インデックス表示 | ツールチップ | 未実装 | なし | ❌ | フェイス/エッジ番号表示 |
| オブジェクト選択 | 未実装 | 未実装 | なし | ❌ | 将来的な機能 |
